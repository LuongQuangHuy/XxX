    ...
    func setupImage(_ arrs: [UIImage] , _ arrString: [String]){
        ...
        for i in 0..<images.count{
            let imageView = UIImageView(frame: CGRect(x: 0,
                                                      ...
                                                      width: width ,
                                                      height: height - 20))
            let label = UILabel(frame: CGRect(x: 0, y: height * CGFloat(i + 1), width: width, height: 20))
            ...
            scrollView.contentSize = CGSize(width: scrollView.frame.width , height: height * CGFloat(arrs.count))
